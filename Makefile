...
LIBRARIES = -L/usr/lib -L/usr/lib/python$(PYTHON_VERSION)/config -L/usr/lib/x86_64-linux-gnu/ -L/usr/local/boost_1_66_0/stage/lib -lpython$(PYTHON_VERSION) -lboost_python
